...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'bg-card text-card-foreground flex flex-col gap-6 rounded-2xl border border-border/70 py-6 shadow-[0_14px_40px_rgba(15,23,42,0.08)] transition-all duration-300',
        className,
      )}
      {...props}
    />
